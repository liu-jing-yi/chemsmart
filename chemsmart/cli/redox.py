...
Registry of reference couples (``RedoxReference``) and dual-level
exchange potential evaluation. Job submission lives under Gaussian,
ORCA, or chain; this module does not invoke a QC backend.
"""
...
from chemsmart.cli.pka import pka_gas_phase_data, pka_solvent_scf_energy
