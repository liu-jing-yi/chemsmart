"""CLI for Gaussian Fukui job submission.
...
Output analysis is backend-independent:
  chemsmart run fukui -n <label>_n.log ...
"""
...
def fukui(
    ...
    **kwargs,
    ...
    """Submit Gaussian Fukui charge-state calculations.
    ...
    logger.info(f"Creating Gaussian Fukui job: mode={mode}")

    from chemsmart.jobs.gaussian.fukui import GaussianFukuiJob

    return GaussianFukuiJob(
        molecule=molecule,
